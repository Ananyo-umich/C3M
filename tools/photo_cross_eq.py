...
data1 = pd.read_csv(data_file1, skiprows = 2, usecols = [0,1,2,3], names = ['wav',
'diss','abs','ion'])
data2 = pd.read_csv(data_file2, skiprows = 2, usecols = [0,1,2,3], names = ['wav',
'diss','abs','ion'])
data3 = pd.read_csv(data_file3, skiprows = 2, usecols = [0,1,2,3], names = ['wav',
'diss','abs','ion'])
data4 = pd.read_csv(data_file4, skiprows = 2, usecols = [0,1,2,3], names = ['wav',
'diss','abs','ion'])
data5 = pd.read_csv(data_file5, skiprows = 2, usecols = [0,1,2,3], names = ['wav',
'diss','abs','ion'])
data6 = pd.read_csv(data_file6, skiprows = 2, usecols = [0,1,2,3], names = ['wav',
'diss','abs','ion'])
