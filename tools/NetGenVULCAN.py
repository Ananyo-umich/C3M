...
# p_JPL, p_SWRI, p_VULCAN, t, t0, m0, m1, m2, m3
      if(rxn.RateFlag == 't'):
        ...
        RateCoeff = 'A: ' + str(double(RateCoeffInfo[0])) + ',b: ' + str(double(RateCoeffInfo[1])) + ',Ea: ' + str(double(RateCoeffInfo[2]))
...
#Three-body reaction
      if(rxn.RateFlag == 'm2'):
        ...
        chem.write('\n  type: falloff')
        RateCoeffInfo = re.findall('[A-Za-z-+.0-9]+', rxn.Data[3])
        RateCoeff_lowP = 'A: ' + str(double(RateCoeffInfo[0])) + ',b: ' + str(double(RateCoeffInfo[1])) + ',Ea: ' + str(double(RateCoeffInfo[2]))
        RateCoeff_highP = 'A: ' + str(double(RateCoeffInfo[3])) + ',b: ' + str(double(RateCoeffInfo[4])) + ',Ea: ' + str(double(RateCoeffInfo[5]))
