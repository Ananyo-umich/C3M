...
with open(args["o"], "w") as chem:
    ...
    for rxn in reaction_array:
        ...
        if rxn.RateFlag == "t":
            ...
            RateCoeff = (
                "A: "
                + str(double(rxn.Data[3]))
                + ",T0: "
                + str(double(rxn.Data[4]))
                + ",b: "
                + str(double(rxn.Data[5]))
                + ",Ea: "
                + str(double(rxn.Data[6]))
            )
            # chem.write("\n  duplicate: true")
        ...
        if rxn.RateFlag == "m2":
            ...
            RateCoeff_highP = (
                "A: "
                + str(double(rxn.Data[7]))
                + ",T0: "
                + str(double(rxn.Data[8]))
                + ",b: "
                + str(double(rxn.Data[9]))
                + ",Ea: "
                + str(double(rxn.Data[10]))
            )
