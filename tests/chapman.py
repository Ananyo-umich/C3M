...
def Jacobian(x):
	...
	xjac[0][0] = 	xjac[0,0] + (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[0][1] = 	xjac[0,1] + (8.2e-12*pow(300/T,-2.060)*exp(0/T)*1.0*pow(x[1],0.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[0][2] = 	xjac[0,2] + (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*1.0*pow(x[2],0.0))#O + O3 = 2O2
	...
	xjac[0][3] = 	xjac[0,3] + (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[1][0] = 	xjac[1,0] + (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
	xjac[1,0] = 	xjac[1,0] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[1][1] = 	xjac[1,1] + (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
	xjac[1,1] = 	xjac[1,1] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*1.0*pow(x[1],0.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[1][2] = 	xjac[1,2] + (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
	xjac[1,2] = 	xjac[1,2] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*1.0*pow(x[2],0.0))#O + O3 = 2O2
	...
	xjac[1][3] = 	xjac[1,3] + (3.2e-11*pow(300/T,0)*exp(70/T)*N*1.0*pow(x[3],0.0))#O_1D = O
	xjac[1,3] = 	xjac[1,3] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[2,0] = 	xjac[2,0] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[2,1] = 	xjac[2,1] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*1.0*pow(x[1],0.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	xjac[2,2] = 	xjac[2,2] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*1.0*pow(x[2],0.0))#O + O3 = 2O2
	...
	xjac[2,3] = 	xjac[2,3] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2

	xjac[3][0] = 	xjac[3,0] + (5e-4*pow(x[2],1.0))#O3 = O_1D + O2
	xjac[3,0] = 	xjac[3,0] - (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
	xjac[3][1] = 	xjac[3,1] + (5e-4*pow(x[2],1.0))#O3 = O_1D + O2
	xjac[3,1] = 	xjac[3,1] - (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
	xjac[3][2] = 	xjac[3,2] + (5e-4*1.0*pow(x[2],0.0))#O3 = O_1D + O2
	xjac[3,2] = 	xjac[3,2] - (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
	xjac[3][3] = 	xjac[3,3] + (5e-4*pow(x[2],1.0))#O3 = O_1D + O2
	xjac[3,3] = 	xjac[3,3] - (3.2e-11*pow(300/T,0)*exp(70/T)*N*1.0*pow(x[3],0.0))#O_1D = O
...
def ReactionRate(x):
	...
	dx[0] = 	dx[0] + (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	dx[1] = 	dx[1] + (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
	dx[1] = 	dx[1] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2
	...
	dx[2] = 	dx[2] - (8.2e-12*pow(300/T,-2.060)*exp(0/T)*pow(x[1],1.0)*pow(x[2],1.0))#O + O3 = 2O2

	dx[3] = 	dx[3] + (5e-4*pow(x[2],1.0))#O3 = O_1D + O2
	dx[3] = 	dx[3] - (3.2e-11*pow(300/T,0)*exp(70/T)*N*pow(x[3],1.0))#O_1D = O
