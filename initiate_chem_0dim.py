...
#Reaction rate and Jacobian functions
#jac = rate 
...
#Jacloss =  "(" + jac + ")"
#code.write("\txjac[" +str(varIndex)+ "] = " + "\txjac[" +str(varIndex)+ "] - " + Jacloss  + '#' + str(reaction_array[rn].Equation) + '\n' )  
